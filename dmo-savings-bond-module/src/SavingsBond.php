...
class SavingsBond
{
    ...
    public function api_routes(){
        ...
        Route::name('sb-api.')->prefix('sb-api')->group(function(){
            ...
            //Route::post('offers', \DMO\SavingsBond\Controllers\API\OfferAPIController::class, 'store');
    ...
    public function routes(){
        ...
        Route::name('sb.')->prefix('sb')->group(function(){
            ...
            //Route::post('offers', \DMO\SavingsBond\Controllers\Models\OfferController::class, 'store');
