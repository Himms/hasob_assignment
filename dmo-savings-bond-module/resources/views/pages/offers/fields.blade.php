...
<div id="div-price_per_unit" class="row mb-4">
    <label for="price_per_unit" class="col-lg-4 col-form-label">Price Per Unit</label>
    <div class="col-sm-9">
...
<div id="div-max_units_per_investor" class="row mb-4">
    <label for="max_units_per_investor" class="col-lg-4 col-form-label">Max Units Per Investor</label>
    <div class="col-sm-9">
...
<div id="div-interest_rate_pct" class="row mb-4">
    <label for="interest_rate_pct" class="col-lg-4 col-form-label">Interest Rate Pct</label>
    <div class="col-sm-9">
